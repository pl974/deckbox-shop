---
title: "Deckbox.fr : Des Box Artisanal d'Exception pour Vos Cartes Magic,
  Pokémon et autre JCC"
description: Découvrez sur Deckbox.fr une sélection exclusive de deckboxes en
  ...
  les joueurs de Magic, Pokémon et autres jeux de cartes, allient esthétique et
  fonctionnalité. Choisissez entre nos modèles à monter soi-même, à customiser
  ou clés en main pour une expérience entièrement personnalisée.
...
---
## **Customiser votre Jeu avec une Deckbox Artisanale**

Plongez au cœur de l'univers des jeux de cartes avec une deckbox qui reflète votre passion. Fabriquées à la main en France, nos deckboxes en bois offrent le mélange parfait , d'élégance et de personnalisation. Que vous soyez du genre Do It Yourself (à faire vous-même) avec nos modèles as moté sois même, customisaton avec nos modèle monter et as peindre ou à préférer la facilité d'une solution clé en main, nous avons ce qu'il vous faut.
